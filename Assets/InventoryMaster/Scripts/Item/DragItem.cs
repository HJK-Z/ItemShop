    ...
    public void OnEndDrag(PointerEventData data)
    {
        if (data.button == PointerEventData.InputButton.Left)
        {
            ...
            if (newSlot != null)
            {
                ...
                if (
                    Inventory.GetComponent<Hotbar>() == null &&
                ...
                )
                {
                    ...
                    {
                        int newSlotChildCount =
                            newSlot.transform.parent.childCount;
                        bool isOnSlot =
                            newSlot.transform.parent.GetChild(0).tag ==
                            "ItemIcon";

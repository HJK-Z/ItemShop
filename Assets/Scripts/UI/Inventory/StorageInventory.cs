...
//             (ItemDataBaseList) Resources.Load("ItemDatabase");
...
//                 Random.Range(1, inventoryItemList.itemList.Count - 1);
...
//                         .Range(1,
//                         inventoryItemList
//                             .itemList[randomItemNumber]
//                             .getCopy()
//                             .maxStack);
//                 Item item =
//                     inventoryItemList.itemList[randomItemNumber].getCopy();
...
//         {
//             timerImage =
//                 GameObject.FindGameObjectWithTag("Timer").GetComponent<Image>();
...
//         if (
//             distance <= distanceToOpenStorage
//         )
//         {
...
//         {
//             iV
//                 .addItemToInventory(storageItems[i].itemID,
//                 storageItems[i].itemValue);
//         }

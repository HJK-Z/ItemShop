...
//             bool gearable = false;
//             Inventory inventory =
//                 transform.parent.parent.parent.GetComponent<Inventory>();
...
//                                 )
//                                 {
//                                     GameObject otherItemFromCharacterSystem =
//                                         eS
//                                             .transform
//                                             .GetChild(1)
//                                             .GetChild(i)
...
//                                             .gameObject;
//                                     Item otherSlotItem =
//                                         otherItemFromCharacterSystem
//                                             .GetComponent<ItemOnObject>()
//                                             .item;
//                                     if (item.itemType == ItemType.UFPS_Weapon)
//                                     {
//                                         inventory
//                                             .UnEquipItem1(otherItemFromCharacterSystem
//                                                 .GetComponent<ItemOnObject>()
//                                                 .item);
//                                         inventory.EquiptItem (item);
//                                     }
...
//                 if (
//                     !gearable &&
//                     item.itemType != ItemType.UFPS_Ammo &&
//                     item.itemType != ItemType.UFPS_Grenade
//                 )
//                 {
//                     Item itemFromDup = null;
//                     if (duplication != null)
//                         itemFromDup =
//                             duplication.GetComponent<ItemOnObject>().item;
...
//                             .gameObject
//                             .transform
//                             .SetParent(eS.transform.GetChild(1).GetChild(i));
//                         this
//                             .gameObject
//                             .GetComponent<RectTransform>()
//                             .localPosition = Vector3.zero;
...
//                                 GameObject dropItem =
//                                     (GameObject)
//                                     Instantiate(otherSlotItem.itemModel);
//                                 dropItem.AddComponent<PickUpItem>();
